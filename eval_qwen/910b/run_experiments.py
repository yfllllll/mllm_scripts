...
TASKS = {
    "烟火检测": {
        "path": "/data1/lyf/data/烟火数据",
        "categories": ["夜间出现的火焰", "夜间出现的烟雾", "夜间烟囱排放的烟雾"]
    },
    "机械施工检测": {
        "path": "/data1/lyf/data/ZGTT-1717104001_机械施工监控",
...
PROMPTS = {
    ...
    "vqa_en": "Observe the image carefully. Is there any object from the following categories: {categories}? Answer only 'yes' or 'no'.",
}

# 默认实验根目录
DEFAULT_OUTPUT_ROOT = "/data1/lyf/data/experiments"
# =================================================
