...
def load_labelme_labels(label_path, image_width, image_height):  
    ...
    with open(label_path, "r") as f:  
        ...
        for shape in data["shapes"]:  
            ...
            bbox_width = attributes.get("bbox_width")
            bbox_height = attributes.get("bbox_height")
            confidence = attributes.get("yolo_confidence")
...
dataset.add_sample_field("ground_truth.detections.bbox_width", fo.FloatField)  
dataset.add_sample_field("ground_truth.detections.bbox_height", fo.FloatField)  
dataset.add_sample_field("ground_truth.detections.confidence", fo.FloatField)  
